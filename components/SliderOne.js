                           ...
                           {/* <img src="/assets/images/Engineer.jpg" className="banner-one__person" alt="" /> */}
                            <div className="row no-gutters">
                                <div className="col-xl-12">
                                    <h3 className="banner-one__title banner-one__light-color">For guaranteed<br />
                                    admissions</h3>
                                    <p className="banner-one__tag-line">to medical & engineering </p>
                                        <p className="banner-one__tag-line-one">Experts in hassle-free admissions
                                           <br/>Recommended by thousands of Doctors and Engineers</p>
                                   <button className='btn'><a href="#registration1" className="thm-btn banner-one__btn">Registration</a></button> 
                                </div>                                
                            </div> 
                        </div>
                    </div>
